...
var PostsModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            imports: [
                typeorm_1.TypeOrmModule.forFeature([post_entity_1.Post, comment_entity_1.Comment, reaction_entity_1.Reaction]),
            ...
            providers: [posts_service_1.PostsService, jwt_auth_guard_1.JwtAuthGuard],
