...
function bootstrap() {
    return __awaiter(this, void 0, void 0, function () {
        var app, logger, expressApp, config, document, port;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.sent();
                    logger.log("\uD83D\uDE80 FeedMe Backend is running on: http://localhost:".concat(port));
                    logger.log("\uD83D\uDCD6 Swagger UI is available at: http://localhost:".concat(port, "/api"));
                    return [2 /*return*/];
            }
        });
    });
